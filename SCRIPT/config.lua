...
CONFIG.Width  = 936;       -- 游戏图形窗口宽, 设置为0则由系统自动适应
CONFIG.Height = 701;      -- 游戏图形窗口高
...
CONFIG.LargeMemory = 0;             --设置内存使用方式 1 多使用内存，0 少使用内存CONFIG.PlayName="牛奶";--主角的名字CONFIG.HPDisplay=1;--战斗血条显示 1 打开 0 关闭

CONFIG.CoupleDisplay = 1;			--战斗开始前是否显示组合动画 1 打开 0 关闭CONFIG.FrameRate=50;--每帧毫秒数，游戏主循环等使用，越高则走路越慢CONFIG.BattleDelay=20;--战斗点数的显示速度，越高则显示越慢CONFIG.Softener=1;--场景柔化 "1"：柔化 "0"：不柔化CONFIG.Bj=0;--暴击震动 "1"：动 "0"：不动

--贴图大小设置CONFIG.Zoom=116;			--100时为远景，200时为近景
